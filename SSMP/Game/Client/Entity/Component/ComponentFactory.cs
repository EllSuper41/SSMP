        ...
        switch (type) {
            ...
            case EntityComponentType.EnemySpawner:
                ...
                return new EnemySpawnerComponent(
                    netClient, entityId, objects, new HostClientPair<EnemySpawner> {
            ...
            case EntityComponentType.SpawnJar:
                ...
                return new SpawnJarComponent(
                    netClient, entityId, objects, new HostClientPair<SpawnJarControl> {
            ...
            case EntityComponentType.SpriteRenderer:
                ...
                return new SpriteRendererComponent(
                    netClient, entityId, objects, new HostClientPair<SpriteRenderer> {
